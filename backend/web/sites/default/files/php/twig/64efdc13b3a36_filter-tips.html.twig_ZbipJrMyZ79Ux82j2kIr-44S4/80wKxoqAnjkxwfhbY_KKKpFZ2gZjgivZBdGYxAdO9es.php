...
class __TwigTemplate_285710a9f00d137ede851bc225a66375 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/seven/templates/classy/content-edit/filter-tips.html.twig", "/app/web/themes/contrib/seven/templates/classy/content-edit/filter-tips.html.twig");
    }
